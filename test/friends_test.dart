...
class FakeFriendsRepository implements FriendsRepository {
  ...
  @override
  Future<void> requestFriend(String uid) => record('request', uid);
  @override
